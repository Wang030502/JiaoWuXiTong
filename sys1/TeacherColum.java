...
public class TeacherColum extends JDialog implements ActionListener {
    //定义窗口所需要的组件
    JPanel jp;
    JButton jb1, jb2;
    TableModel tm;
    ...
    public TeacherColum(Frame Main, String title, boolean model) {
        //调用父类的构造方法，实现模式对话
        super(Main, title, model);
        //设置窗体的属性
        jtb = new JTable();
        tm = new TeacherColumModel(null, i, m);//进去先显示第一周的
        jtb.setModel(tm);
        //让表格显示信息
        jtb.setVisible(true);
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if (arg0.getSource() == jb2) {
            if (m > 17) {
                ...
                tm = new TeacherColumModel(null, i, m);
                jtb.setModel(tm);
            }
